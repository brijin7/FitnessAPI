...
namespace Fitness.Controllers.BranchMaster
{
    //[Authorize]
    [RoutePrefix("api/branchGallery")]
    public class mstrBranchGalleryController : ApiController
    {
        readonly DAL_MstrBranchGallery DAL_MstrBranchGallery = new DAL_MstrBranchGallery();


        /// <summary>
        /// this method is used to get BranchGallery details
        /// </summary>
        /// <param name="Input">GetBranchGallery_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetBranchGalleryMasterAsync([FromUri] GetBranchGallery_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrBranchGallery.UD_GetBranchGalleryAsync(Input);

                return GetSuccessOrFailureResForSelect<GetBranchGallery_Out>(listOfGetConfigMstr_Out, "No Records Found In BranchGallery Master !!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert BranchGallery
        /// </summary>
        /// <param name="Input">InsertBranchGallery_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertBranchGalleryMasterAsync([FromBody] InsertBranchGallery_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrBranchGallery.UD_InsertMstrBranchGalleryAsync(Input);
        ...
        /// <summary>
        /// this method is used to update BranchGallery master
        /// </summary>
        /// <param name="Input">UpdateBranchGallery_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateBranchGalleryMasterAsync([FromBody] UpdateBranchGallery_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrBranchGallery.UD_UpdateBranchGalleryAsync(Input);
        ...
        /// <summary>
        /// this method is used to Active InActive BranchGallery master
        /// </summary>
        /// <param name="Input">ActivateOrInactivateBranchGallery_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("activeOrInActive")]
        public async Task<IHttpActionResult> ActivateOrInactivateBranchGalleryAsync([FromBody] ActivateOrInactivateBranchGallery_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrBranchGallery.UD_ActivateOrInactivateBranchGalleryMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
