...
{
                   //[Authorize]
    [RoutePrefix("api/subscriptionBenefits")]
    public class mstrSubscriptionBenefitsController : ApiController
    {
        readonly DAL_MstrSubscriptionBenefits DAL_MstrSubscriptionBenefits = new DAL_MstrSubscriptionBenefits();


        /// <summary>
        /// this method is used to get SubscriptionBenefits details
        /// </summary>
        /// <param name="Input">GetSubscriptionBenefits_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetSubscriptionBenefitsMasterAsync([FromUri] GetSubscriptionBenefits_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrSubscriptionBenefits.UD_GetSubscriptionBenefitsAsync(Input);

                return GetSuccessOrFailureResForSelect<GetSubscriptionBenefits_Out>(listOfGetConfigMstr_Out, "No Records Found In SubscriptionBenefits Master !!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert SubscriptionBenefits
        /// </summary>
        /// <param name="Input">InsertSubscriptionBenefits_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertSubscriptionBenefitsMasterAsync([FromBody] InsertSubscriptionBenefits_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrSubscriptionBenefits.UD_InsertMstrSubscriptionBenefitsAsync(Input);
        ...
        /// <summary>
        /// this method is used to update SubscriptionBenefits master
        /// </summary>
        /// <param name="Input">UpdateSubscriptionBenefits_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateSubscriptionBenefitsMasterAsync([FromBody] UpdateSubscriptionBenefits_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrSubscriptionBenefits.UD_UpdateSubscriptionBenefitsAsync(Input);
        ...
        /// <summary>
        /// this method is used to Active InActive SubscriptionBenefits master
        /// </summary>
        /// <param name="Input">ActivateOrInactivateSubscriptionBenefits_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("activeOrInActive")]
        public async Task<IHttpActionResult> ActivateOrInactivateSubscriptionBenefitsAsync([FromBody] ActivateOrInactivateSubscriptionBenefits_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrSubscriptionBenefits.UD_ActivateOrInactivateSubscriptionBenefitsMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
