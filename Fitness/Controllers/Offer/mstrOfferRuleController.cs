...
namespace Fitness.Controllers.OfferRule
{
                    //[Authorize]
    [RoutePrefix("api/offerRule")]
    public class mstrOfferRuleController : ApiController
    {
        readonly DAL_MstrOfferRule DAL_MstrOfferRule = new DAL_MstrOfferRule();


        /// <summary>
        /// this method is used to get OfferRule details
        /// </summary>
        /// <param name="Input">GetOfferRule_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetOfferRuleMasterAsync([FromUri] GetOfferRule_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrOfferRule.UD_GetOfferRuleAsync(Input);

                return GetSuccessOrFailureResForSelect<GetOfferRule_Out>(listOfGetConfigMstr_Out, "No Records Found In OfferRule Master !!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert OfferRule
        /// </summary>
        /// <param name="Input">InsertOfferRule_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertOfferRuleMasterAsync([FromBody] InsertOfferRule_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrOfferRule.UD_InsertMstrOfferRuleAsync(Input);
        ...
        /// <summary>
        /// this method is used to update OfferRule master
        /// </summary>
        /// <param name="Input">UpdateOfferRule_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateOfferRuleMasterAsync([FromBody] UpdateOfferRule_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrOfferRule.UD_UpdateOfferRuleAsync(Input);
        ...
        /// <summary>
        /// this method is used to Active InActive OfferRule master
        /// </summary>
        /// <param name="Input">ActivateOrInactivateOfferRule_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("activeOrInActive")]
        public async Task<IHttpActionResult> ActivateOrInactivateOfferRuleAsync([FromBody] ActivateOrInactivateOfferRule_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrOfferRule.UD_ActivateOrInactivateOfferRuleMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
