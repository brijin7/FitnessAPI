...
using Fitness.Models.DataAccessLayer.MessageTemplate;
using static Fitness.Models.BusinessObject.MessageTemplate.BOL_MstrMessageTemplate;

namespace Fitness.Controllers.MessageTemplate
{
              //[Authorize]
    [RoutePrefix("api/messageTemplateMaster")]
    public class mstrMessageTemplateController : ApiController
    {
        readonly DAL_MstrMessageTemplate DAL_MstrMessageTemplate = new DAL_MstrMessageTemplate();

        /// <summary>
        /// this method is used to get MessageTemplatemstr details
        /// </summary>
        /// <param name="Input">GetMessageTemplateMstr_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetMessageTemplateMasterAsync()
        {
            try
            {

                var listOfGetConfigMstr_Out = await DAL_MstrMessageTemplate.UD_GetMessageTemplateMstrAsync();

                return GetSuccessOrFailureResForSelect<GetMessageTemplateMstr_Out>(listOfGetConfigMstr_Out, "No Records Found In Message Template Master!!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert MessageTemplatemstr
        /// </summary>
        /// <param name="Input">InsertMessageTemplate_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertMessageTemplateMasterAsync([FromBody] InsertMessageTemplate_In Input)
        {
            try
            {
                ...
                DB_Response DB_res = await DAL_MstrMessageTemplate.UD_InsertMessageTemplateMasterAsync(Input);
        ...
        /// <summary>
        /// this method is used to update MessageTemplateMaster
        /// </summary>
        /// <param name="Input">UpdateMessageTemplateMstr_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateFaqMasterAsync([FromBody] UpdateMessageTemplateMstr_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrMessageTemplate.UD_UpdateMessageTemplateMstrAsync(Input);
