...
{
                  //[Authorize]
    [RoutePrefix("api/workoutMealPlan")]
    public class mstrWorkoutMealPlanController : ApiController
    {
        readonly DAL_MstrWorkoutMealPlan DAL_MstrworkoutMealPlan = new DAL_MstrWorkoutMealPlan();


        /// <summary>
        /// this method is used to get workoutMealPlan details
        /// </summary>
        /// <param name="Input">GetworkoutMealPlan_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetworkoutMealPlanMasterAsync([FromUri] GetworkoutMealPlan_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrworkoutMealPlan.UD_GetworkoutMealPlanAsync(Input);

                return GetSuccessOrFailureResForSelect<GetworkoutMealPlan_Out>(listOfGetConfigMstr_Out, "No Records Found In workoutMealPlan Master !!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert workoutMealPlan
        /// </summary>
        /// <param name="Input">InsertworkoutMealPlan_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertworkoutMealPlanMasterAsync([FromBody] InsertworkoutMealPlan_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrworkoutMealPlan.UD_InsertMstrworkoutMealPlanAsync(Input);
        ...
        /// <summary>
        /// this method is used to update workoutMealPlan master
        /// </summary>
        /// <param name="Input">UpdateworkoutMealPlan_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateworkoutMealPlanMasterAsync([FromBody] UpdateworkoutMealPlan_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrworkoutMealPlan.UD_UpdateworkoutMealPlanAsync(Input);
        ...
        /// <summary>
        /// this method is used to Active InActive workoutMealPlan master
        /// </summary>
        /// <param name="Input">ActivateOrInactivateworkoutMealPlan_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("activeOrInActive")]
        public async Task<IHttpActionResult> ActivateOrInactivateworkoutMealPlanAsync([FromBody] ActivateOrInactivateworkoutMealPlan_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrworkoutMealPlan.UD_ActivateOrInactivateworkoutMealPlanMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
