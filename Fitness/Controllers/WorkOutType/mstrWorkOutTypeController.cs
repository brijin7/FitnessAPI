...
using Fitness.Models.DataAccessLayer.WorkOutType;

namespace Fitness.Controllers.WorkOutType
{
                  //[Authorize]
    [RoutePrefix("api/workoutType")]
    public class mstrWorkOutTypeController : ApiController
    {
        readonly DAL_MstrWorkOutType DAL_MstrWorkOutType = new DAL_MstrWorkOutType();
        ...
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetMstrWorkoutTypeAsync([FromUri] GetMstrWorkoutType_In Input)
        {
            try
            {
                ...
                var listOfGetMstrWorkoutType_Out = await DAL_MstrWorkOutType.UD_GetMstrWorkoutTypeAsync(Input);

                return GetSuccessOrFailureResForSelect<GetMstrWorkoutType_Out>(listOfGetMstrWorkoutType_Out, "No Records Found In WorkOut Type!!!");
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("GetWorkOutTypeSub")]
        public async Task<IHttpActionResult> GetMstrWorkoutTypeAsync([FromUri] GetMstrWorkoutTypeSub_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var listOfGetMstrWorkoutType_Out = await DAL_MstrWorkOutType.UD_GetMstrWorkoutTypeSubAsync(Input);

                return GetSuccessOrFailureResForSelect<GetMstrWorkoutTypeSub_Out>(listOfGetMstrWorkoutType_Out, "No Records Found In WorkOut Type!!!");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertMstrWorkoutTypeAsync([FromBody] InsertMstrWorkoutType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrWorkOutType.UD_InsertMstrWorkoutTypeAsyc(Input);
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateMstrWorkoutTypeAsync([FromBody] UpdateMstrWorkoutType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrWorkOutType.UD_UpdateMstrWorkoutTypeAsyc(Input);
        ...
        public async Task<IHttpActionResult> ActiveOrInactiveMstWorkoutTypeAsync([FromBody] ActivateOrInactivateMstrWorkoutType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrWorkOutType.UD_ActivateOrInactivateMstrWorkoutTypAsyc(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
