...
using Fitness.Models.DataAccessLayer.UserAttendance;
using Newtonsoft.Json.Linq;

namespace Fitness.Controllers.UserAttendance
{
    [RoutePrefix("api/userAttendance")]
    public class mstr_UserAttendanceController : ApiController
    {
        readonly DAL_UserAttendance DAL_UserAttendance = new DAL_UserAttendance();
        ...
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> UD_GetUserAttendanceAsync([FromUri] GetUserAttendance_In Input)
        {
            try
            {
                ...
                var listOfUserAttendance_Out = await DAL_UserAttendance.UD_GetUserAttendanceAsync(Input);

                return GetSuccessOrFailureResForJArray(listOfUserAttendance_Out, "No Records Found In User Attendance!!!");
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("GetTrainerBasedUsers")]
        public async Task<IHttpActionResult> UD_GetTrainerBasedUsersAsync([FromUri] GetTrainerBasedUsers_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var listOfUserAttendance_Out = await DAL_UserAttendance.UD_GetTrainerBasedUsersAsync(Input);

                return GetSuccessOrFailureResForJArray(listOfUserAttendance_Out, "No Records Found In Trainer Based User!!!");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        /// <summary>
        /// this method is used to insert UserAttendancemaster
        /// </summary>
        /// <param name="Input">InsertUserAttendance_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertUserAttendanceAsync([FromBody] InsertUserAttendance_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_UserAttendance.UD_InsertUserAttendanceAsync(Input);
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateUserAttendanceAsync([FromBody] UpdateUserAttendance_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_UserAttendance.UD_UpdateUserAttendanceMstrAsync(Input);
        ...
        [HttpPost]
        [Route("updateByTrainer")]
        public async Task<IHttpActionResult> UpdateUserAttendanceByTrainerAsync([FromBody] UpdateUserAttendanceByTrainer_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_UserAttendance.UD_UpdateUserAttendanceByTrainerMstrAsync(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
