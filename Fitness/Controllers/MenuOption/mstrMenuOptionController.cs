...
using Fitness.Models.DataAccessLayer.MenuOption;
...
namespace Fitness.Controllers.MenuOption
{
    //[Authorize]
    [RoutePrefix("api/menuOption")]
    public class mstrMenuOptionController : ApiController
    {
        readonly DAL_MstrMenuOption MenuOption = new DAL_MstrMenuOption();

        /// <summary>
        /// this method is used to Get Menu Option
        /// </summary>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetMstrMenuOptionAsync()
        {
            try
            {
                JArray JsonResult = await MenuOption.UD_GetMenuOptionAsync();

                return GetSuccessOrFailureResForJArray(JsonResult, "No Menu Options Found !!!.");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to insert Menu Option
        /// </summary>
        /// <param name="Input">InsertMenuOption_In as Input</param>
        /// <returns></returns>
        [HttpPost]
        [Route("Insert")]
        public async Task<IHttpActionResult> InsertMstrMenuOptionAsync(InsertMenuOption_In Input)
        {
            try
            {
                ...
                DB_Response Response = await MenuOption.UD_InsertMenuOptionAsync(Input);

                return GetDBSuccessOrInfoResponse(Response, "Create");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        /// <summary>
        /// this method is used to update Menu Option
        /// </summary>
        /// <param name="Input">UpdateMenuOption_In as Input</param>
        /// <returns></returns>
        [HttpPost]
        [Route("Update")]
        public async Task<IHttpActionResult> UpdateMstrMenuOptionAsync(UpdateMenuOption_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response Response = await MenuOption.UD_UpdateMenuOptionAsync(Input);

                return GetDBSuccessOrInfoResponse(Response, "");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        public async Task<IHttpActionResult> ActiveOrInactiveMstrMenuOptionAsync(ActiveOrInactiveMenuOption_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response Response = await MenuOption.UD_ActiveOrInactiveMenuOptionAsync(Input);
