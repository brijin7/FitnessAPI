...
using Fitness.Models.DataAccessLayer.UpdateBookingPaymentStatus;
using Microsoft.AspNetCore.Http;
using Swashbuckle.Swagger;

namespace Fitness.Controllers.UpdateBookingPaymentStatus
{
    //[Authorize]

    [RoutePrefix("api/updateBookingPaymentStatus")]
    public class UpdateBookingPaymentStatusController : ApiController
    {
        DAL_UpdateBookingPaymentStatus DAL = new DAL_UpdateBookingPaymentStatus();
        ...
        [HttpPost]
        [Route("UPIPmtStatus")]
        public async Task<IHttpActionResult> UpdateBookingPaymentStatus([FromBody] UpdateBookingPaymentStatus_In Input)
        {
            try
            {
                ...
                DB_Response result = await DAL.UD_UpdatePaymentStatusAsync(Input);

                return GetDBSuccessOrInfoResponse(result, "");
            }
            catch (Exception Ex)
            {
