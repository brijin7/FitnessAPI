...
namespace Fitness.Controllers.UserMaster
{
                  //[Authorize]
    [RoutePrefix("api/userTestimonials")]
    public class mstrUserTestimonialsController : ApiController
    {
        readonly DAL_MstrUserTestimonials DAL_MstrUserTestimonials = new DAL_MstrUserTestimonials();


        /// <summary>
        /// this method is used to get UserTestimonials details
        /// </summary>
        /// <param name="Input">GetUserTestimonials_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetUserTestimonialsMasterAsync([FromUri] GetUserTestimonials_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrUserTestimonials.UD_GetUserTestimonialsAsync(Input);

                return GetSuccessOrFailureResForSelect<GetUserTestimonials_Out>(listOfGetConfigMstr_Out, "No Records Found In UserTestimonials Master !!!");
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        [Route("AllUser")]
        public async Task<IHttpActionResult> GetAllUserTestimonialsMasterAsync()
        {
            try
            {
                var listOfGetConfigMstr_Out = await DAL_MstrUserTestimonials.UD_GetAllUserTestimonialsAsync();
        ...
        /// <summary>
        /// this method is used to get Branch Testimonials details
        /// </summary>
        /// <param name="Input">GetUserTestimonials_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("BranchTestimonials")]
        public async Task<IHttpActionResult> GetBranchTestimonialsMasterAsync([FromUri] GetBranchTestimonials_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrUserTestimonials.UD_GetBranchTestimonialsAsync(Input);

                return GetSuccessOrFailureResForSelect<GetUserTestimonials_Out>(listOfGetConfigMstr_Out, "No Records Found In Branch Testimonials Master !!!");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        /// <summary>
        /// this method is used to insert UserTestimonials
        /// </summary>
        /// <param name="Input">InsertUserTestimonials_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertUserTestimonialsMasterAsync([FromBody] InsertUserTestimonials_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrUserTestimonials.UD_InsertMstrUserTestimonialsAsync(Input);
        ...
        /// <summary>
        /// this method is used to update UserTestimonials master
        /// </summary>
        /// <param name="Input">UpdateUserTestimonials_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateUserTestimonialsMasterAsync([FromBody] UpdateUserTestimonials_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrUserTestimonials.UD_UpdateUserTestimonialsAsync(Input);
