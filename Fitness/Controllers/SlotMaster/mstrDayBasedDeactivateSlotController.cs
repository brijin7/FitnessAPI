...
{
    [RoutePrefix("api/dayBasedDeactivatedslotMaster")]
    public class mstrDayBasedDeactivateSlotController : ApiController
    {
        readonly DAL_DeactivateSlots DAL_DeactivateSlots = new DAL_DeactivateSlots();
        ...
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> UD_GetSlotMasterAsync([FromUri] GetDeactivatedSlotMaster_In Input)
        {
            try
            {
                ...
                var listOfSlotMaster_Out = await DAL_DeactivateSlots.UD_GetSlotMasterAsync(Input);

                return GetSuccessOrFailureResForJArray(listOfSlotMaster_Out, "No Records Found In DayBased Deactivated Slot Master!!!");
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertSlotMasterAsync([FromBody] InsertDeactivatedSlotMaster_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_DeactivateSlots.UD_InsertSlotMasterAsync(Input);
        ...
        public async Task<IHttpActionResult> ActiveOrInactiveCategoryMasterAsync([FromBody] ActivateOrInactivateDeactivatedSlotMaster_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_DeactivateSlots.UD_ActivateOrInactivateDeactivatedSlotMasterMstrAsyn(Input);
