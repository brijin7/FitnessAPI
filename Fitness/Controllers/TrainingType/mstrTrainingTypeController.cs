...
using Fitness.Models.DataAccessLayer.TrainingType;
namespace Fitness.Controllers.TrainingType
{
               //[Authorize]
    [RoutePrefix("api/trainingTypeMaster")]
    public class mstrTrainingTypeController : ApiController
    {
        readonly DAL_TrainingType DAL_MstrTrainingType = new DAL_TrainingType();


        /// <summary>
        /// this method is used to get TrainingType details
        /// </summary>
        /// <param name="Input">GetTrainingType_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetTrainingTypeMasterAsync([FromUri] ddlTrainingType_In Input)
        {
            try
            {

                var listOfGetTrainingType_Out = await DAL_MstrTrainingType.UD_GetTrainingTypeAsync(Input);

                return GetSuccessOrFailureResForSelect<GetTrainingType_Out>(listOfGetTrainingType_Out, "No Records Found In TrainingType Master !!!");
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("getDropDownDeatils")]
        public async Task<IHttpActionResult> ddlTrainingTypeMasterAsync([FromUri] ddlTrainingType_In Input)
        {
            try
            {
                ...
                var listOfGetTrainingType_Out = await DAL_MstrTrainingType.UD_ddlTrainingTypeTypeAsync(Input);

                return GetSuccessOrFailureResForSelect<ddlTrainingType_Out>(listOfGetTrainingType_Out, "No Records Found In TrainingType Master !!!");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        /// <summary>
        /// this method is used to insert TrainingType
        /// </summary>
        /// <param name="Input">InsertTrainingType_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertTrainingTypeMasterAsync([FromBody] InsertTrainingType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrTrainingType.UD_InsertMstrTrainingTypeAsync(Input);
        ...
        /// <summary>
        /// this method is used to update TrainingType master
        /// </summary>
        /// <param name="Input">UpdateTrainingType_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateTrainingTypeMasterAsync([FromBody] UpdateTrainingType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrTrainingType.UD_UpdatetrainingTypeAsync(Input);
        ...
        /// <summary>
        /// this method is used to Active InActive TrainingType master
        /// </summary>
        /// <param name="Input">ActivateOrInactivateTrainingType_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("activeOrInActive")]
        public async Task<IHttpActionResult> ActivateOrInactivateTrainingTypeAsync([FromBody] ActivateOrInactivateTrainingType_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrTrainingType.UD_ActivateOrInactivateTrainingTypeMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
