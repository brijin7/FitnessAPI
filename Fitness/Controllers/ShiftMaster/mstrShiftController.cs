...
using Fitness.Models.DataAccessLayer.ShiftMaster;
using static Fitness.Models.BusinessObject.ShiftMaster.BOL_MstrShift;
using Newtonsoft.Json.Linq;

namespace Fitness.Controllers.ShiftMaster
{
    //[Authorize]
    [RoutePrefix("api/shiftMaster")]
    public class mstrShiftController : ApiController
    {
        readonly DAL_MstrShift DAL_MstrShift = new DAL_MstrShift();

        /// <summary>
        /// this method is used to get Shiftmstr details
        /// </summary>
        /// <param name="Input">GetShiftMstr_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetShiftMasterAsync()
        {
            try
            {

                var listOfGetConfigMstr_Out = await DAL_MstrShift.UD_GetShiftMstrAsync();

                return GetSuccessOrFailureResForJArray(listOfGetConfigMstr_Out, "No Records Found In ShiftMaster!!!");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// this method is used to get Shiftmstr details based on branch
        /// </summary>
        /// <param name="Input">GetShiftMstr_In class as input parameter</param>
        /// <returns></returns>
        [HttpGet]
        [Route("branchBasedShift")]
        public async Task<IHttpActionResult> GetShiftMasterAsync([FromUri] GetShiftMstr_In Input)
        {
            try
            {
                ...
                var listOfGetConfigMstr_Out = await DAL_MstrShift.UD_GetShiftMstrBasedOnBranchAsync(Input);
        ...
        /// <summary>
        /// this method is used to get ddlShiftmstr details
        /// </summary>
        /// <param name="Input">GetddlShiftMstr_In class as input parameter</param>
        /// <returns></returns>

        [HttpGet]
        [Route("GetDropDownDetailsShift")]
        public async Task<IHttpActionResult> ddlMstrShiftAsync([FromUri] ddlGetShiftMstr_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var listOfGetMstrBranch_Out = await DAL_MstrShift.UD_GetddlShiftMstrAsync(Input);

                return GetSuccessOrFailureResForJArray(listOfGetMstrBranch_Out, "No Records Found In Shift Master!!!");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
        ...
        /// <summary>
        /// this method is used to insert Shiftmstr
        /// </summary>
        /// <param name="Input">InsertShift_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("insert")]
        public async Task<IHttpActionResult> InsertShiftMasterAsync([FromBody] InsertShift_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrShift.UD_InsertShiftMasterAsync(Input);
        ...
        /// <summary>
        /// this method is used to update ShiftMaster
        /// </summary>
        /// <param name="Input">UpdateShiftMstr_In class as input parameter</param>
        /// <returns></returns>
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateShiftMasterAsync([FromBody] UpdateShiftMstr_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrShift.UD_UpdateShiftMstrAsync(Input);
        ...
        public async Task<IHttpActionResult> ActiveOrInactiveShiftMasterAsync([FromBody] ActivateOrInactivateShiftMstr_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_MstrShift.UD_ActivateOrInactivateShiftMstrAsyn(Input);
                return GetDBSuccessOrInfoResponse(DB_res, "");
            }
            catch (Exception ex)
            {
