...
using Fitness.Models.DataAccessLayer.SingleLogin;
...
namespace Fitness.Controllers.SingleLogin
{
                   //[Authorize]
    [RoutePrefix("api/login")]
    public class SingleLoginController : ApiController
    {
        readonly DAL_SingleLogin DAL_SingleLogin = new DAL_SingleLogin();

        /// <summary>
        /// this method is used for login
        /// </summary>
        /// <param name="Input">UpdateSingleLogin_In as Input class</param>
        /// <returns></returns>
        /// 
        [HttpPost]
        [Route("checkLogin")]
        public async Task<IHttpActionResult> UpdateSingleLoginAsync([FromBody]UpdateSingleLogin_In Input)
        {
            try
            {
                ...
                DB_Response DB_res = await DAL_SingleLogin.UD_UpdateSingleLoginAsync(Input);
        ...
        /// <summary>
        /// this method is used for Relogin
        /// </summary>
        /// <param name="Input">UpdateSingleLogin_In as Input class</param>
        /// <returns></returns>
        [HttpPost]
        [Route("checkReLogin")]
        public async Task<IHttpActionResult> UpdateSingleReLoginAsync([FromBody] UpdateSingleReLogin_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DB_Response DB_res = await DAL_SingleLogin.UD_UpdateSingleReLoginAsync(Input);
        ...
        /// <summary>
        /// this method is used to GetSessionId
        /// </summary>
        /// <param name="Input">GetUserSessionId_In as Input class</param>
        /// <returns></returns>
        [HttpGet]
        [Route("GetSessionId")]
        public async Task<IHttpActionResult> GetSessionIdAsync([FromUri]GetUserSessionId_In Input)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                JArray JOut = await DAL_SingleLogin.UD_GetUserSessionId(Input);

                return GetSuccessOrFailureResForJArray(JOut, "No SessionId Is Found !!!.");
            }
            catch (Exception ex)
            {
                return GetErrorResponse(ex);
